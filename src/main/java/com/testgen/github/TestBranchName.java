...
public record TestBranchName(String value) {
    ...
    static TestBranchName forHealing(String testClassName) {
        return new TestBranchName(TESTGEN_BRANCH_PREFIX + "heal-" + testClassName + "-" + UUID.randomUUID().toString().substring(0, 8));
    }
}
